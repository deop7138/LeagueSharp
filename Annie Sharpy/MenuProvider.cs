...
namespace Annie_Sharpy
{
    ...
    class MenuProvider
    {
        ...
        internal static void initialize()
        {
            ...
            {
                MenuInstance = new Menu("Annie Sharpy", "Annie_SharpyCommon", true);
            ...
            {
                MenuInstance = new Menu("Annie Sharpy: " + "(X)", "Annie_SharpyCommon", true);
            ...
            Console.WriteLine("Annie Sharpy: MenuProvider Initialized.");
        }
