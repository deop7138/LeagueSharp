    ...
    public static class Orbwalking
    {
        ...
        public class Orbwalker
        {
            ...
            public Orbwalker(Menu attachToMenu)
            {
                ...
                _config.AddItem(
                    new MenuItem("LineCombo", "LineCombo").SetValue(new KeyBind('T', KeyBindType.Press)));
            ...
            public OrbwalkingMode ActiveMode
            {
                get
                {
                    ...
                    if (_config.Item("LineCombo").GetValue<KeyBind>().Active)
                    {
                        return OrbwalkingMode.LineCombo;
                    }
