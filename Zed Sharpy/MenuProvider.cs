...
namespace Zed_Sharpy
{
    ...
    class MenuProvider
    {
        ...
        internal static void initialize()
        {
            ...
            {
                MenuInstance = new Menu("Zed Sharpy", "Zed_SharpyCommon", true);
            ...
            {
                MenuInstance = new Menu("Zed Sharpy: " + "(X)", "Zed_SharpyCommon", true);
            ...
            Console.WriteLine("Zed Sharpy: MenuProvider Initialized.");
        }
