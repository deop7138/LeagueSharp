...
namespace Cassio_Sharpy
{
    ...
    class MenuProvider
    {
        ...
        internal static void initialize()
        {
            ...
            {
                MenuInstance = new Menu("Cassio Sharpy", "Cassio_SharpyCommon", true);
            ...
            {
                MenuInstance = new Menu("Cassio Sharpy: " + "(X)", "Cassio_SharpyCommon", true);
            ...
            Console.WriteLine("Cassio Sharpy: MenuProvider Initialized.");
        }
